    ...
    const fetchEmployee = async () => {
        try {
            ...
            if (data && data.employee) {
                ...
                setValue('employename', data.employee.employename);
                setValue('designation', data.employee.designation);
                setValue('empID', data.employee.empID);
                setValue('DOJ', data.employee.DOJ);
                setValue('DOR', data.employee.DOR);
            } else {
