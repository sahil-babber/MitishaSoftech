...
function AddEmploye() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_APP_API_BASE_URL}/employees/createEmploye`, {
        method: 'POST',
        headers: {
            ...
            <Form onSubmit={handleSubmit(onSubmit)} className="mt-4">
              <Form.Group controlId="formEmployeName" className="mb-3">
                ...
                <Form.Control
                  ...
                  {...register('employename', { required: 'Employee name is required' })}
              ...
              <Form.Group controlId="formDOJ" className="mb-3">
                <Form.Label> <strong>Date of Joining </strong> (DOJ)</Form.Label>
                <Form.Control
                  type="date"
              ...
              <Form.Group controlId="formDOR" className="mb-4">
                <Form.Label> <strong>Date of Resignation</strong> (DOR)</Form.Label>
                <Form.Control
