...
function VerifyEmploye() {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const response = await axios.post('/employees/findEmploye', data);
        ...
        <>
            <Form onSubmit={handleSubmit(onSubmit)}>
                <Form.Control
                    ...
                    {...register("empID", { required: "Emp ID / Registration no. is required" })}
                            ...
                            <Table  striped bordered hover>
                                <tbody>
                                    ...
                                    <tr className="table-row-odd">
                                        <th>Name</th>
                                        <td className='text-capitalize'>{employeeData.employename}</td>
                                    </tr>
                                    <tr className="table-row-even">
                                        <th>Designation</th>
                                        <td className='text-capitalize'>{employeeData.designation}</td>
                                    </tr>
                                    <tr className="table-row-even">
                                        <th>DOJ</th>
